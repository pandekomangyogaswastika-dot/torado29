...
import { Users as UsersIcon, Shield, Database, ScrollText, Hash, ArrowRight, Activity, Plug } from "lucide-react";
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Sistem Torado ERP siap melayani. Phase 2 Foundation aktif.
            </p>
          </div>
