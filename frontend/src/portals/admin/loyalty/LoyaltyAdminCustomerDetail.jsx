    ...
    <div className="space-y-5" data-testid="admin-loyalty-customer-detail">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold tabular-nums mt-1">{detail.transaction_count}</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="text-xs uppercase text-muted-foreground">Redemption</div>
            <div className="text-2xl font-bold tabular-nums mt-1">{detail.redemption_count}</div>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue="profile">
        <TabsList>
          ...
          <TabsTrigger value="redemptions">Redemption ({redemptions.length})</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="profile" className="mt-4">
          <Card>
            ...
            <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <Label>Email</Label>
                <Input value={c.email} disabled className="mt-1.5 bg-muted" />
              </div>
              <div>
