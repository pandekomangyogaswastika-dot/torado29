    ...
    <div className="space-y-4">
      ...
      <div className="glass-card p-5">
        <div className="flex flex-col sm:flex-row sm:items-end gap-4 sm:gap-3 sm:flex-wrap">
          <div className="sm:min-w-[220px] flex-1">
            <Label className="text-[11px] uppercase tracking-wide text-muted-foreground font-semibold" htmlFor="pc-outlet">Outlet</Label>
            <select
              id="pc-outlet"
              value={outletId}
      ...
      <div className="glass-card">
        <DataList
          ...
          empty={
            !outletId
              ? <EmptyState title="Pilih outlet untuk melihat petty cash" />
              : <EmptyState
                  icon={Wallet}
