...
import { Plus, Calendar, Filter, Receipt, Eye } from "lucide-react";
      ...
      <div className="glass-card p-4">
        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:items-end">
          ...
          <div className="sm:min-w-[180px] flex-1">
            <label className="text-[11px] uppercase tracking-wide text-muted-foreground font-semibold" htmlFor="ds-outlet">
