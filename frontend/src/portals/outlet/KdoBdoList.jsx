        ...
        <DataList
          columns={[
            ...
            { key: "request_date", label: "Tanggal", render: pr => fmtDate(pr.request_date) },
            {
              ...
              render: pr => outlets.find(o => o.id === pr.outlet_id)?.name || pr.outlet_id,
            },
            {
...
function KdoBdoForm({ kind, meta, open, userOutlets, onClose, onSaved }) {
