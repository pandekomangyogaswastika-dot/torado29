      ...
      <DialogContent className="max-w-3xl w-full">
        ...
        <div className="flex gap-2">
          ...
          <label>
            ...
            <input type="file" accept="image/*" className="hidden" onChange={handleQuickUpload} disabled={uploading} />
          </label>
        </div>
        ...
        <ScrollArea className="h-[380px]">
          {loading ? (
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2 pr-2">
              {items.map((item) => {
        ...
        {selected && (
          <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/40 border border-primary/20">
