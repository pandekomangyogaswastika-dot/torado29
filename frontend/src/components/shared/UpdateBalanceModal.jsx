      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-3">
            ...
            <>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Input id="code" value={form.code} onChange={(e) => updateField("code", e.target.value)} placeholder="auto" />
                </div>
                <div>
              ...
              <div>
                ...
                <Input id="name" value={form.name} onChange={(e) => updateField("name", e.target.value)} placeholder="BCA Operasional" />
              </div>
              {form.type === "bank" && (
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label>Bank</Label>
                    <Input value={form.bank_name} onChange={(e) => updateField("bank_name", e.target.value)} placeholder="BCA" />
                  </div>
                  <div>
                    <Label>No. Rekening</Label>
                    <Input value={form.bank_account_no} onChange={(e) => updateField("bank_account_no", e.target.value)} />
                  </div>
                </div>
              )}
              <div>
                <Label>Opening Balance</Label>
                <Input value={form.opening_balance} onChange={(e) => updateField("opening_balance", e.target.value)} type="number" />
              </div>
            </>
          )}
          ...
          <div>
            ...
            <Input value={form.current_balance} onChange={(e) => updateField("current_balance", e.target.value)} type="number" placeholder="0" />
          </div>
