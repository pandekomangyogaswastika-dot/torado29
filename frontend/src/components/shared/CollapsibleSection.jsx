...
async function fetchCollapsedSet() {
  ...
  _fetchPromise = api
    ...
    .catch((err) => {
      console.warn("[CollapsibleSection] Failed to fetch /preferences/me:", err?.message || err);
      _setCache = new Set();
      return _setCache;
    });
...
function persistDebounced() {
  ...
  _persistTimer = setTimeout(async () => {
    ...
    try {
      ...
      console.warn("[CollapsibleSection] Failed to persist collapsed_widgets:", err?.message || err);
    }
  }, 400);
}
