...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen" data-testid="contact-page">
      <PageSEO
        title="Contact"
        description="Hubungi Torado Group untuk reservasi, partnership, event corporate, atau pertanyaan umum. Kami siap membantu."
        path="/contact"
        keywords="kontak Torado Group, reservasi restoran Jakarta, partnership F&B, event corporate Jakarta"
      />
      {/* Header */}
