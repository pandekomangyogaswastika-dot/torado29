...
export default function Careers() {
  ...
  const handleApply = (e) => {
    e.preventDefault();
    toast.success("Lamaran terkirim! Tim HR kami akan menghubungi Anda.");
    setApplyOpen(false);
  ...
  return (
    <div className="min-h-screen" data-testid="careers-page">
      <PageSEO
        title="Careers"
        description="Bergabunglah dengan tim Torado Group. Kami mencari individu bersemangat di bidang F&B, hospitality, teknologi, dan operasional. Lihat lowongan terbuka hari ini."
        path="/careers"
        keywords="karir Torado Group, lowongan F&B Jakarta, kerja restoran Jakarta, hospitality jobs"
      />
      ...
      <Dialog open={applyOpen} onOpenChange={setApplyOpen}>
        <DialogContent className="bg-[#F8F5EF] border border-[#1C1510]/20 text-[#1C1510] max-w-md">
          ...
          <form onSubmit={handleApply} className="space-y-4 mt-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-[#1C1510] text-white text-sm font-medium rounded-full hover:bg-[#1C1510]/85 transition-colors"
