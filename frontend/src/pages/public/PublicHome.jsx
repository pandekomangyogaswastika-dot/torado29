...
export default function PublicHome() {
  ...
  return (
    <div data-testid="public-home-page">
      <PageSEO
        title="Crafted F&B Experiences in Jakarta"
        description="Torado Group menghadirkan pengalaman kuliner autentik melalui 4 brand ikonik: Altero, De La Sol, Calluna, dan Bakkies. Temukan cita rasa terbaik Jakarta."
        path="/"
        keywords="Torado Group, restaurant Jakarta, Altero, De La Sol, Calluna, Bakkies, F&B Jakarta, kuliner Jakarta"
      />
      <Hero />
      <Marquee />
      {brands.map((brand, i) => (
