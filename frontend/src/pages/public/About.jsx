...
export default function About() {
  return (
    <div className="min-h-screen" data-testid="about-page">
      <PageSEO
        title="About Us"
        description="Torado Group adalah hospitality group yang membangun ekosistem F&B terbaik di Jakarta sejak 2015. Menggabungkan kreativitas kuliner dengan standar operasional internasional."
        path="/about"
