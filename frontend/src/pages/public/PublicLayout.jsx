      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between h-16 lg:h-[72px]">
          ...
          <Link to="/" className="flex items-center gap-2" data-testid="public-header-logo">
            <span
              className="text-[#1C1510] font-semibold tracking-[0.22em] uppercase text-sm"
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/loyalty/login"
              className="hidden lg:flex items-center gap-1.5 px-4 py-2 rounded-full text-[13px] font-semibold transition-all hover:scale-[1.02]"
              style={{
                background: "#1C1510",
                color: "#F8F5EF",
                boxShadow: "0 2px 10px rgba(28,21,16,0.15)",
              }}
            ...
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              <SheetTrigger asChild>
                <button
                  className="lg:hidden flex items-center justify-center h-9 w-9 text-[#1C1510]/70 hover:text-[#1C1510]"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 pb-12 border-b border-white/10">
          ...
          <div className="grid grid-cols-2 gap-8 lg:col-span-2">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[{l:"About",to:"/about"},{l:"News",to:"/news"},{l:"Careers",to:"/careers"},{l:"Contact",to:"/contact"}].map(({l,to}) => (
