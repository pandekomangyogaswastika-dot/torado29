...
export default function NewsPage() {
  ...
  return (
    <div className="min-h-screen" data-testid="news-page">
      <PageSEO
        title="News & Stories"
        description="Berita terbaru, cerita di balik dapur, event eksklusif, dan update terkini dari semua brand Torado Group."
        path="/news"
        keywords="berita Torado Group, event F&B Jakarta, update kuliner Jakarta"
      />
      {/* Header */}
