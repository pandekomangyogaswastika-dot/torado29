...
async def get_customer(
    ...
    if not cust:
        raise AuroraException("CUSTOMER_NOT_FOUND", "Customer not found", "customer_id")
...
async def get_invoice(
    ...
    if not invoice:
        raise AuroraException("INVOICE_NOT_FOUND", "Invoice not found", "invoice_id")
    return ok_envelope(invoice)
